<%@page import="org.bluepigeon.admin.dao.BuilderTaxTypeDAO"%>
<%@page import="org.bluepigeon.admin.model.BuilderTaxType"%>
...
List<BuilderTaxType> listCountry = countryService.getBuilderCompany();
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/builder/tax/type/save',
					caption: "Tax Type",
					//,autowidth: true,
