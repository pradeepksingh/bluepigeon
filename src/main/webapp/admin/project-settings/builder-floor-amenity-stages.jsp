...
if (request.getParameterMap().containsKey("amenity_id")) {
	...
	if (amenity_id > 0) {
		amenity_stage_list = new BuilderFloorAmenityStagesDAO().getFloorAmenityStagesByAmenityId(amenity_id);
		amenity_stage_size = amenity_stage_list.size(); 
	}
} else {
	amenity_stage_list = new BuilderFloorAmenityStagesDAO().getBuilderFloorAmenityStagesList();
	amenity_stage_size = amenity_stage_list.size(); 
}
...
<!-- 				                </div> -->
                                ...
                                <table class="table table-striped table-bordered" id="flooramenitystagetable">
                                    ...
                                    <tbody>
                                        ...
                                        %>
                                        <tr>
                                        	<td><%out.print(amenity_stage_list.get(i).getBuilderFloorAmenity().getName()); %></td>
