...
<input type="hidden" value="" name="builder_id" id="builder_id">
		    ...
		    function getBuilderData(){
		    	...
		    	if($("#builder_id").val()>0){
		    		var  builder_info = {id:$("#builder_id").val(),name:$("#bname").val(),status:$("#status").val(),headOffice:$("#hoffice").val(),email:$("#hemail").val(),mobile:$("#hphno").val(),aboutBuilder:$("#abuilder").val()}
		    	}else{
		    		var  builder_info = {name:$("#bname").val(),status:$("#status").val(),headOffice:$("#hoffice").val(),email:$("#hemail").val(),mobile:$("#hphno").val(),aboutBuilder:$("#abuilder").val()}
		    	}
		    	return builder_info;
