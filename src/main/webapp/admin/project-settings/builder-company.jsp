<%@page import="org.bluepigeon.admin.dao.BuilderCompanyDAO"%>
<%@page import="org.bluepigeon.admin.model.BuilderCompany"%>
...
List<BuilderCompany> listCountry = countryService.getBuilderCompany();
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/builder/company/save',
					caption: "Building Amenities stages and sub stages",
					//,autowidth: true,
