                                ...
                                <table class="table table-striped table-bordered" id="citytable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><% if(locality_list.get(i).getStatus() == true) { out.print("<span class='label label-success'>Active</span>"); } else { out.print("<span class='label label-warning'>Inactive</span>"); } %></td>
                                            <td class="alignRight">
