                                ...
                                <table class="table table-striped table-bordered" id="homeloanbanktable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><% if(home_loan_bank_list.get(i).getStatus() == 1) { out.print("<span class='label label-success'>Active</span>"); } else { out.print("<span class='label label-warning'>Inactive</span>"); } %></td>
                                            <td class="alignRight">
...
<%--                                             	<a href="javascript:deleteAreaUnit(<% out.print(home_loan_bank_list.get(i).getId()); %>);" class="btn btn-danger btn-xs icon-btn"><i class="fa fa-trash-o"></i></a> --%>
                                            </td>
...
function editHomeLoanBank(bankid) {
	$.get("${baseUrl}/general/edithomeloanbank.jsp?bank_id="+bankid,{ }, function(data){
		$("#modalarea").html(data);
