                    ...
                    <div class="col-sm-12">
                        <div class="white-box"><br>
                          <center> <h1>Manage Demand Letters</h1> </center> 
                             <br>
                          <a href="${baseUrl}/builder/demandletters/demand-letter.jsp"> <span class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Add Demand Letter</span></a>
                           <br><br><br>
