											...
											<div class="form-group" id="error-builder_id">
												...
												<div class="col-sm-5">
													<select id="project_id" name="project_id" class="form-control">
														...
														<% for (BuilderProject builder : builderProjects) { %>
...
$("#project_id").change(function(){
	if($("#builder_id").val() != "") {
		$.get("${baseUrl}/webapi/create/building/buyer/list/",{ project_id: $("#project_id").val() }, function(data){
...
$("#building_id").change(function(){
	if($("#building_id").val() != "") {
		$.get("${baseUrl}/webapi/create/building/buyer/list/",{ building_id: $("#building_id").val() }, function(data){
