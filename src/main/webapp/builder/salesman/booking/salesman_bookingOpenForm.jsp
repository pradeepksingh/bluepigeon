...
<!--     <link rel="stylesheet" href="../../css/bootstrap-multiselect.css"> -->
    ...
    <link rel="stylesheet" type="text/css" href="../../css/salesmanbooking.css">
...
function showFlat(id){
	ajaxindicatorstart("Loading...");
	window.location.href="${baseUrl}/builder/salesman/booking/Salesman_booking_form3.jsp?flat_id="+id;
}
function showBuyerDetails(flatId){
	ajaxindicatorstart("Loading...");
	window.location.href="${baseUrl}/builder/salesman/booking/edit_booking_form.jsp?flat_id="+flatId;
}
...
function getFlatDetails(){
	var no = $("#filter_building_id").val();
		$.get("${baseUrl}/builder/salesman/booking/flatlist.jsp?project_id="+<%out.print(project_id);%>+"&building_id="+no+"&floor_id="+$("#filter_floor_id").val()+"&evenOrodd="+$("#evenOrodd").val(),{ }, function(data){
			if($.trim(data)){
