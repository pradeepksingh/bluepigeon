...
if(session_uid > 0){
	campaignLists = new CampaignDAO().getCampaignListByBuilderId(session_uid); 
}
%>
<!DOCTYPE html>
<html lang="en">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box"><br>
                          <center><h1>Manage Campaign</h1></center> 
                           <br>
                            <a href=""> <span class="btn btn-danger pull-right m-l-20 btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Add Campaign</span></a>
                           <br><br><br>
