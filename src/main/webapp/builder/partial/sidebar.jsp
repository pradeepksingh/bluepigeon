...
<!--                         input-group -->
            ...
            <li> <a href="javascript:void(0);" class="waves-effect"><i class="ti-layout fa-fw"></i><span class="hide-menu"> CEO<span class="fa arrow"></span></span></a>
				<ul class="nav nav-second-level">
					<li> <a href="${baseUrl }/builder/ceo/inbox.jsp">Inbox</a></li>
                    <li> <a href="${baseUrl }/builder/ceo/data_analytics.jsp">Data Analytics</a></li>
                    <li> <a href="${baseUrl }/builder/ceo/employee.jsp">Employee</a></li>
