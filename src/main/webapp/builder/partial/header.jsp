...
<nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part"><a class="logo" href="${baseUrl}/builder/dashboard.jsp"><b><img src="${baseUrl}/builder/plugins/images/bpadmin-logo.png" alt="home" width="150px"/></b><span class="hidden-xs"></a></div>
