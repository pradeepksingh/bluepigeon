...
<nav class="navbar navbar-default navbar-static-top m-b-0">
            <div class="navbar-header">
                ...
                <div class="top-left-part"><a class="logo" href="index.html"><b><img src="../plugins/images/bpadmin-logo.png" alt="home" width="80px" height="50px"/></b><span class="hidden-xs"></a></div>
