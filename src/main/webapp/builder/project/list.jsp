                    ...
                    <div class="container" id="project_list">
                       	...
                       	<div class="col-md-6 col-sm-6 col-xs-12 projectsection" id="projectlist">
	                       	...
	                       	%>
		                       	...
		                       	<%}}catch(Exception e){ %>
		                       		 <img  src="../plugins/images/Untitled-1.png" height="348"  width="438" alt="Project image"/>
		                       	<%} %>
		                       	<div class="overlay">
			                       	<div class="row">
...
<!-- 						                 	</div> -->
	                       ...
	                       <div class="row">
                           	<div class="col-md-6 center"> 
                           		<a href="${baseUrl}/builder/project/edit.jsp?project_id=<% out.print(projectList.getId());%>" class="btn btn11 btn-success waves-effect waves-light m-t-10">Manage</a>
                           	</div>
                         	<div class="col-md-6 center">
