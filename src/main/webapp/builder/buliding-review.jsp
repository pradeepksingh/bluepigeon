                    ...
                    <div class="col-lg-12">
                        <div class="white-box">
                             ...
                             <br>-->
                              ...
                              <div class="tab-content"> 
                               ...
                               <div id="vimessages" class="tab-pane active" aria-expanded="false">
                                ...
                                <div class="form-group row">
                                    <label for="example-search-input" class="col-3 col-form-label">Buliding Name</label>
                                    <div class="col-6">
                                        <select class="form-control">
                             ...
                             <form>
                                 ...
                                 <div class="form-group row">
                                    <label for="example-search-input" class="col-3 col-form-label">Buliding Launch Date*</label>
                                    <div class="col-6">
                                        <input class="form-control" type="text" value="project" id="example-search-input">
                                    </div>
