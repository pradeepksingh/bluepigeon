...
<%
	...
	if(session!=null)
	{
		if(session.getAttribute("ubname") != null)
		{
			...
			if(builder_uid > 0){
				source_list = new ProjectDAO().getAllSourcesByBuilderId(builder_uid);
				int builder_size = source_list.size();
			}
		}
   	}
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="white-box"><br>
                          <center><h1>Manage Source</h1></center> <br>
                            <div class="table-responsive">
                                <table id="tblLeads" class="table table-striped">
									...
									<td>
										...
										<td>
										<a href="${baseUrl}/builder/sales/edit-source.jsp?source_id=<% out.print(source.getId());%>"> <span class="btn btn-success pull-left btn-sm btn-rounded btn-outline hidden-xs hidden-sm waves-effect waves-light">Manage</span></a>
										</td>
										<% 	i++;
											} 
                                      	}
