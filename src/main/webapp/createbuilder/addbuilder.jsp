	...
	<div class="main-content-inner">
		...
		<div class="page-content">
			<div class="page-header">
				<h1>
					Builder List
					<a href="${baseUrl}/createbuilder/newBuilder.jsp" class="btn btn-primary btn-sm pull-right" role="button" data-toggle="modal"><i class="fa fa-plus"></i> New Builder</a>
				</h1>
			</div>
			<div class="row">
				<div class="col-xs-12">
...
<%@include file="../footer.jsp"%>
		...
		<script type="text/javascript">
			...
			function editBuilder(id){
				window.location.href = "${baseUrl}/createbuilder/editBuilder.jsp?id="+id;
			}
