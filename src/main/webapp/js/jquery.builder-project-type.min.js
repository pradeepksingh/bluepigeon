...
function editProjectType(id){
	...
	$.post("../../webapi/create/builder/project/type/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../../admin/project-settings/builder-project-type.jsp";
	});
}
function delProjectType(id){
	alert(id);
	$.ajax({
		url: "../../webapi/create/builder/project/type/delete",
		data:{id:id},
		type:'delete',
