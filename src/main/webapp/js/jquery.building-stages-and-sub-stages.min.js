...
function editBuildingStages(id){
	...
	$.post("../webapi/create/building/stages/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-building-stages-and-sub-stages.jsp";
	});
}
function delBuildingStages(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/building/stages/delete",
		data:{id:id},
		type:'delete',
