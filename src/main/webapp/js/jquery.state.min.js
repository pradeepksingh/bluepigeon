...
function editBuildingStatus(id){
	...
	$.post("../webapi/create/building/status/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/building-status.jsp";
	});
}
function delBuildingStatus(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/building/status/delete",
		data:{id:id},
		type:'delete',
