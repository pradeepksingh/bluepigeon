...
function editProjectAmenitiesStages(id){
	...
	$.post("../webapi/create/builder/project/amenities/satges/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-project-amenities-stages-and-sub-stages.jsp";
	});
}
function delProjectAmenitiesStages(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/builder/project/amenities/satges/delete",
		data:{id:id},
		type:'delete',
