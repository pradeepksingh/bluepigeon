...
function editBuilderCompany(id){
	...
	$.post("../webapi/create/builder/company/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-company.jsp";
	});
}
function delBuilderCompany(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/builder/company/delete",
		data:{id:id},
		type:'delete',
