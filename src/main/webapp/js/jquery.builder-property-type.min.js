...
function editPropertyType(id){
	...
	$.post("../../webapi/create/builder/property/type/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../../admin/project-settings/builder-property-type.jsp";
	});
}
function delPropertyType(id){
	alert(id);
	$.ajax({
		url: "../../webapi/create/builder/property/type/delete",
		data:{id:id},
		type:'delete',
