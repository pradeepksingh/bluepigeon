...
function editFloorAmenitiesStages(id){
	...
	$.post("../webapi/create/floor/amenities/stages/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-floor-amenities-stages-and-sub-stages.jsp";
	});
}
function delFloorAmenitiesStages(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/floor/amenities/stages/delete",
		data:{id:id},
		type:'delete',
