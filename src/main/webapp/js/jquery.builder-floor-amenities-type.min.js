...
function editFloorAmenitiesType(id){
	...
	$.post("../webapi/create/floor/amenities/type/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-floor-amenities-type.jsp";
	});
}
function delFloorAmenitiesType(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/floor/amenities/type/delete",
		data:{id:id},
		type:'delete',
