...
function editBuilderFlatStatus(id){
	...
	$.post("../webapi/create/flat/status/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-flat-status.jsp";
	});
}
function delBuilderFlatStatus(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/flat/status/delete",
		data:{id:id},
		type:'delete',
