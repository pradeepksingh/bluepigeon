...
function editCountry(id){
	...
	$.post("../webapi/general/country/update", {id: id, name: $("#"+id+"_name").val(), sortOrder: 1, stock: checkStock}, function(data){
		window.location.href = "../general/country.jsp";
	});
}
function delCountry(id){
	alert(id);
	$.ajax({
		url: "../webapi/general/country/delete",
		data:{id:id},
		type:'delete',
