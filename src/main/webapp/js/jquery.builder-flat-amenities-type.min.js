...
function editFlatAmenitiesType(id){
	...
	$.post("../webapi/create/flat/amenities/type/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-flat-amenities-type.jsp";
	});
}
function delFlatAmenitiesType(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/flat/amenities/type/delete",
		data:{id:id},
		type:'delete',
