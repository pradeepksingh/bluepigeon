...
function editProjectLevel(id){
	...
	$.post("../webapi/create/builder/project/level/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-project-level.jsp";
	});
}
function delProjectLevel(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/builder/project/level/delete",
		data:{id:id},
		type:'delete',
