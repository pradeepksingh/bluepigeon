...
function editProjectStatus(id){
	...
	$.post("../../webapi/create/builder/project/status/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../../admin/project-settings/builder-project-status.jsp";
	});
}
function delProjectStatus(id){
	alert(id);
	$.ajax({
		url: "../../webapi/create/builder/project/status/delete",
		data:{id:id},
		type:'delete',
