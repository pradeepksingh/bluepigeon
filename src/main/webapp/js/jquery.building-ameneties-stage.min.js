...
function editBuildingAmenetiesStages(id){
	...
	$.post("../webapi/create/building/ameneties/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/building-ameneties-stages.jsp";
	});
}
function delBuildingAmenetiesStages(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/building/ameneties/delete",
		data:{id:id},
		type:'delete',
