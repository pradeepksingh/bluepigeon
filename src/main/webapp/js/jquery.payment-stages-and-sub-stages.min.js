...
function editPaymentStages(id){
	...
	$.post("../webapi/create/builder/payment/satges/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-payment-stages-and-sub-stages.jsp";
	});
}
function delPaymentStages(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/builder/payment/satges/delete",
		data:{id:id},
		type:'delete',
