...
function editSellerType(id){
	...
	$.post("../../webapi/create/builder/seller/type/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../../admin/project-settings/builder-seller-type.jsp";
	});
}
function delSellerType(id){
	alert(id);
	$.ajax({
		url: "../../webapi/create/builder/seller/type/delete",
		data:{id:id},
		type:'delete',
