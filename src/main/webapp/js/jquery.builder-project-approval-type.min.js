...
function editProjectApprovalType(id){
	...
	$.post("../webapi/create/builder/project/approval/type/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-project-approval-type.jsp";
	});
}
function delProjectApprovalType(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/builder/project/approval/type/delete",
		data:{id:id},
		type:'delete',
