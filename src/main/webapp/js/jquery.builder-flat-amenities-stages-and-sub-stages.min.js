...
function editFlatAmenitiesStages(id){
	...
	$.post("../webapi/create/flat/amenities/stages/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-flat-amenities-stages-and-sub-stages.jsp";
	});
}
function delFlatAmenitiesStages(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/flat/amenities/stages/delete",
		data:{id:id},
		type:'delete',
