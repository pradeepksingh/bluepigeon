...
function editBuilderGroup(id){
	...
	$.post("../webapi/create/builder/group/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-group.jsp";
	});
}
function delBuilderGroup(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/builder/group/delete",
		data:{id:id},
		type:'delete',
