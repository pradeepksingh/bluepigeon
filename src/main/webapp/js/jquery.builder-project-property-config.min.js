...
function editProjectPropertyConfig(id){
	...
	$.post("../webapi/create/builder/project/propertyconfig/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-project-property-configuration.jsp";
	});
}
function delProjectPropertyConfig(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/builder/project/propertyconfig/delete",
		data:{id:id},
		type:'delete',
