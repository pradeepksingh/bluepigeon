...
function editBuildingAmenetiesType(id){
	...
	$.post("../webapi/create/building/amenetiestype/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/building-ameneties-type.jsp";
	});
}
function delBuildingAmenetiesType(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/building/amenetiestype/delete",
		data:{id:id},
		type:'delete',
