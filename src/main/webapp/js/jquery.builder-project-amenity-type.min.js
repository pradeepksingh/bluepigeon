...
function editProjectAmenetyType(id){
	...
	$.post("../webapi/create/builder/project/amenities/type/update", {id: id, name: $("#"+id+"_name").val(), stock: checkStock}, function(data){
		window.location.href = "../createprojects/builder-project-amenity-type.jsp";
	});
}
function delProjectAmenetyType(id){
	alert(id);
	$.ajax({
		url: "../webapi/create/builder/project/amenities/type/delete",
		data:{id:id},
		type:'delete',
