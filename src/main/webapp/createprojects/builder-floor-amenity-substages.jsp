...
$("#searchstageId").change(function(){
	window.location.href = "${baseUrl}/createprojects/builder-floor-amenity-substages.jsp?stage_id="+$("#searchstageId").val();
});

function editFloorAmenitySubstage(substageid) {

	$.get("${baseUrl}/createprojects/editbuilderflooramenitysubstages.jsp?substage_id="+substageid,{ }, function(data){
		$("#modalarea").html(data);
