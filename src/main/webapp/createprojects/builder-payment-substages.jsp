...
$("#searchpaymentId").change(function(){
	window.location.href = "${baseUrl}/createprojects/builder-payment-substages.jsp?payment_id="+$("#searchpaymentId").val();
});
...
function editPaymentSubstages(payment_stage_id) {
	...
	$.get("${baseUrl}/createprojects/editbuilderpaymentsubstage.jsp?payment_stage_id="+payment_stage_id,{ }, function(data){
		$("#modalarea").html(data);
