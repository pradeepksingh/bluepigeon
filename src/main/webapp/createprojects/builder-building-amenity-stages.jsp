...
$("#searchamenityId").change(function(){
	window.location.href = "${baseUrl}/createprojects/builder-building-amenity-stages.jsp?amenity_id="+$("#searchamenityId").val();
});
...
function editBuildingAmenityStages(amenity_stage_id) {
	...
	$.get("${baseUrl}/createprojects/editbuildingamenitystage.jsp?amenity_stage_id="+amenity_stage_id,{ }, function(data){
		$("#modalarea").html(data);
