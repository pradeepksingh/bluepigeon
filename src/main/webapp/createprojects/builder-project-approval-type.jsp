...
function editProjectApprovalType(project_approval_id) {
	$.get("${baseUrl}/createprojects/editbuilderprojectapprovaltype.jsp?project_approval_id="+project_approval_id,{ }, function(data){
		$("#modalarea").html(data);
...
// 	if(yes==true){
// 		$.ajax({
// 			url: "${baseUrl}/webapi/create/builder/project/approval/type/delete",
