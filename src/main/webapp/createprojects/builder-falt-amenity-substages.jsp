...
$("#searchstageId").change(function(){
	window.location.href = "${baseUrl}/createprojects/builder-flat-amenity-substages.jsp?stage_id="+$("#searchstageId").val();
});

function editFlatAmenitySubstage(substageid) {

	$.get("${baseUrl}/createprojects/editbuilderflatamenitysubstages.jsp?substage_id="+substageid,{ }, function(data){
		$("#modalarea").html(data);
