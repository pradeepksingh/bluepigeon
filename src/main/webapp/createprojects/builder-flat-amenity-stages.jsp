...
$("#searchamenityId").change(function(){
	window.location.href = "${baseUrl}/createprojects/builder-flat-amenity-stages.jsp?amenity_id="+$("#searchamenityId").val();
});
...
function editFlatAmenityStages(amenity_stage_id) {
	...
	$.get("${baseUrl}/createprojects/editflatamenitystage.jsp?amenity_stage_id="+amenity_stage_id,{ }, function(data){
		$("#modalarea").html(data);
