...
$("#searchstageId").change(function(){
	window.location.href = "${baseUrl}/createprojects/builder-project-amenity-substages.jsp?stage_id="+$("#searchstageId").val();
});

function editProjectAmenitySubstage(substageid) {

	$.get("${baseUrl}/createprojects/editbuilderprojectamenitysubstages.jsp?substage_id="+substageid,{ }, function(data){
		$("#modalarea").html(data);
