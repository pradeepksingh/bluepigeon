...
$("#searchstageId").change(function(){
	window.location.href = "${baseUrl}/createprojects/builder-building-amenity-substages.jsp?stage_id="+$("#searchstageId").val();
});

function editBuildingAmenitySubstage(substageid) {

	$.get("${baseUrl}/createprojects/editbuilderbuildingamenitysubstages.jsp?substage_id="+substageid,{ }, function(data){
		$("#modalarea").html(data);
