	...
	<div class="main-content-inner">
		<div class="breadcrumbs ace-save-state" id="breadcrumbs">
			<ul class="breadcrumb">
				...
				<li class="active">Builder overall project stages and sub stages</li>
			</ul>
			<!-- /.breadcrumb -->
		</div>
		...
		<div class="page-content">
			...
			<div class="page-header">
				<h1>
					Builder overall project stages and sub stages
				</h1>
			</div>
			<!-- /.page-header -->
...
<script src="${baseUrl}/js/jquery.builder-overall-project-stages-and-sub-stages.min.js"></script>
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/builder/project/satges/save',
					caption: "Builder overall project stages and sub stages",
					//,autowidth: true,
