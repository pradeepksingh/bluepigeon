...
List<BuilderSellerType> listCountry = countryService.getBuilderCompany();
...
<script src="${baseUrl}/js/jquery.builder-seller-type.min.js"></script>
			...
			jQuery(function($) {
				...
				*/
				...
				//		minusicon  : "ace-icon fa fa-minus center bigger-110 blue",
					...
					editurl: '${baseUrl}/webapi/create/builder/seller/type/save',
					caption: "Seller Type",
					//,autowidth: true,
